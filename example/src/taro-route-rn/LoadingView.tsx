...
class LoadingView extends React.Component<LoadingViewProps, IState> {
  private destroyAnimate: boolean;
  private compositeAnimation?: Animated.CompositeAnimation;
  constructor(props: LoadingViewProps) {
    super(props);
    this.destroyAnimate = false;
    this.state = {
  ...
  startAnimation() {
    ...
    this.compositeAnimation = Animated.timing(this.state.rotateValue, {
      toValue: 1,
      duration: 2000,
  ...
  componentWillUnmount() {
    this.destroyAnimate = true;
    this.compositeAnimation && this.compositeAnimation.stop();
  }
