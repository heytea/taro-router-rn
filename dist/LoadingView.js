...
class LoadingView extends react_1.default.Component {
    constructor(props) {
        ...
        this.state = {
            rotateValue: new react_native_1.Animated.Value(0),
        };
    }
    startAnimation() {
        this.state.rotateValue.setValue(0);
        this.compositeAnimation = react_native_1.Animated.timing(this.state.rotateValue, {
            toValue: 1,
            duration: 2000,
    ...
    render() {
        return (react_1.default.createElement(react_native_1.Animated.View, { style: {
            ...
            react_1.default.createElement(react_native_1.Image, { style: [styles.img, { tintColor: this.props.tintColor }], source: {
